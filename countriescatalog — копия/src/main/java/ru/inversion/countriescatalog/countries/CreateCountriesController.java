 ...
 */
public class CreateCountriesController extends JInvFXFormController<POkSm> {
    ...
    private void addCountries() {
        try {
            new ParamMap()
                    ...
                    .add("cshname", CSHORTNAME.getText())
                    .add("clnname", CLONGNAME.getText())
                    .exec(this, "addOksm");
